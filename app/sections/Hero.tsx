  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-white rounded-lg">
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6">
        ...
        <span className="text-indigo-600"> In Ethereum.</span>
        <br />
        <span className="text-black">No Middlemen.</span>
      </h1>
      <p className="text-lg sm:text-xl text-black mb-8 max-w-2xl mx-auto">
        The future of subscription payments is here. Manage recurring payments using Ethereum for subscriptions, services, and content. Powered by smart contracts, built for Web3.
      </p>
      <Link 
        href="/dashboard"
